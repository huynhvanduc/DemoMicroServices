...
namespace Ordering.Application.IntegrationEvents.EventsHandler;
...
public class BasketCheckoutEventHandler : IConsumer<BasketCheckoutEvent>
{
    ...
    public async Task Consume(ConsumeContext<BasketCheckoutEvent> context)
    {
        ...
        _logger.Information($"{nameof(BasketCheckoutEvent)} consumed successfully. Order is created with Id: {result.Data}");
    }
}
